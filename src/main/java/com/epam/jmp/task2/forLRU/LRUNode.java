...
/**
 * Class which implementing LinkedListNode interface.
 *
 * @param <T> value.
 */
public class LRUNode<T> implements LinkedListNode<T> {
    ...
    public LRUNode(T value, LinkedListNode<T> next, DoublyLinkedList<T> list) {
        this.value = value;
        this.next = next;
